...
always @(core_w_mem_inst_w_ctr_reg, core_w_mem_inst_w_tmp, core_w_mem_inst_w_new, core_w_mem_inst_w_mem[0], core_w_mem_inst_w_mem[1], core_w_mem_inst_w_mem[2], core_w_mem_inst_w_mem[3], core_w_mem_inst_w_mem[4], core_w_mem_inst_w_mem[5], core_w_mem_inst_w_mem[6], core_w_mem_inst_w_mem[7], core_w_mem_inst_w_mem[8], core_w_mem_inst_w_mem[9], core_w_mem_inst_w_mem[10], core_w_mem_inst_w_mem[11], core_w_mem_inst_w_mem[12], core_w_mem_inst_w_mem[13], core_w_mem_inst_w_mem[14], core_w_mem_inst_w_mem[15]) begin: SHA1_CORE_W_MEM_INST_SELECT_W
...
always @(core_w_mem_inst_w_mem00_new, core_w_mem_inst_w_mem01_new, core_w_mem_inst_w_mem02_new, core_w_mem_inst_w_mem03_new, core_w_mem_inst_w_mem04_new, core_w_mem_inst_w_mem05_new, core_w_mem_inst_w_mem06_new, core_w_mem_inst_w_mem07_new, core_w_mem_inst_w_mem08_new, core_w_mem_inst_w_mem09_new, core_w_mem_inst_w_mem10_new, core_w_mem_inst_w_mem11_new, core_w_mem_inst_w_mem12_new, core_w_mem_inst_w_mem13_new, core_w_mem_inst_w_mem14_new, core_w_mem_inst_w_mem15_new, core_w_mem_inst_w_mem_we, core_w_mem_inst_w_new, core_w_init, core_block, core_w_mem_inst_w_ctr_reg, core_w_mem_inst_w_mem[1], core_w_mem_inst_w_mem[2], core_w_mem_inst_w_mem[3], core_w_mem_inst_w_mem[4], core_w_mem_inst_w_mem[5], core_w_mem_inst_w_mem[6], core_w_mem_inst_w_mem[7], core_w_mem_inst_w_mem[8], core_w_mem_inst_w_mem[9], core_w_mem_inst_w_mem[10], core_w_mem_inst_w_mem[11], core_w_mem_inst_w_mem[12], core_w_mem_inst_w_mem[13], core_w_mem_inst_w_mem[14], core_w_mem_inst_w_mem[15]) begin: SHA1_CORE_W_MEM_INST_W_MEM_UPDATE_LOGIC
    reg [32-1:0] w_13;
    reg [32-1:0] w_16;
    reg [32-1:0] w_0;
    reg [32-1:0] w_8;
...
always @(core_w_mem_inst_w_ctr_new, core_w_mem_inst_w_ctr_we, core_w_mem_inst_w_ctr_rst, core_w_mem_inst_w_ctr_inc, core_w_mem_inst_w_ctr_reg) begin: SHA1_CORE_W_MEM_INST_W_CTR
...
always @(core_w_mem_inst_w_ctr_rst, core_w_mem_inst_w_ctr_inc, core_w_mem_inst_sha1_w_mem_ctrl_new, core_w_mem_inst_sha1_w_mem_ctrl_we, core_w_mem_inst_sha1_w_mem_ctrl_reg, core_w_init, core_w_next, core_w_mem_inst_w_ctr_reg) begin: SHA1_CORE_W_MEM_INST_SHA1_W_MEM_FSM
...
always @(core_digest_init, core_digest_update, core_H0_new, core_H1_new, core_H2_new, core_H3_new, core_H4_new, core_H_we, core_H0_reg, core_H1_reg, core_H2_reg, core_H3_reg, core_H4_reg, core_a_reg, core_b_reg, core_c_reg, core_d_reg, core_e_reg) begin: SHA1_CORE_DIGEST_LOGIC
    core_H0_new <= 0;
    core_H1_new <= 0;
    core_H2_new <= 0;
    core_H3_new <= 0;
...
always @(core_a_new, core_b_new, core_c_new, core_d_new, core_e_new, core_a_e_we, core_state_init, core_first_block, core_H0_reg, core_H1_reg, core_H2_reg, core_H3_reg, core_H4_reg, core_round_ctr_reg, core_a_reg, core_b_reg, core_c_reg, core_d_reg, core_e_reg, core_w, core_state_update) begin: SHA1_CORE_STATE_LOGIC
    reg [32-1:0] k;
    reg [32-1:0] a5;
    reg [32-1:0] t;
    reg [32-1:0] f;
...
always @(core_round_ctr_new, core_round_ctr_we, core_round_ctr_rst, core_round_ctr_inc, core_round_ctr_reg) begin: SHA1_CORE_ROUND_CTR
...
always @(core_digest_init, core_digest_update, core_state_init, core_state_update, core_first_block, core_ready_flag, core_w_init, core_w_next, core_round_ctr_inc, core_round_ctr_rst, core_digest_valid_new, core_digest_valid_we, core_sha1_ctrl_new, core_sha1_ctrl_we, core_sha1_ctrl_reg, init_reg, core_round_ctr_reg, next_reg) begin: SHA1_CORE_SHA1_CTRL_FSM
    core_digest_init <= 0;
...
always @(init_new, next_new, block_we, tmp_read_data, tmp_error, address, cs, we, write_data, block_reg[0], block_reg[1], block_reg[2], block_reg[3], block_reg[4], block_reg[5], block_reg[6], block_reg[7], block_reg[8], block_reg[9], block_reg[10], block_reg[11], block_reg[12], block_reg[13], block_reg[14], block_reg[15], digest_reg, next_reg, init_reg, digest_valid_reg, ready_reg) begin: SHA1_API
    init_new <= 0;
    next_new <= 0;
    block_we <= 0;
    tmp_read_data <= 0;
