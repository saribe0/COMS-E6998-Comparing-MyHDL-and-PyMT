//======================================================================
// VRegIncr_0x7a81360b75b3f561_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_RegIncr_0x7a81360b75b3f561/VRegIncr_0x7a81360b75b3f561.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RegIncr_0x7a81360b75b3f561/VRegIncr_0x7a81360b75b3f561__Syms.h"
#include "svdpi.h"
#endif
...
VRegIncr_0x7a81360b75b3f561_t * create_model( const char *vcd_filename ) {

  VRegIncr_0x7a81360b75b3f561_t * m;
  VRegIncr_0x7a81360b75b3f561   * model;

  Verilated::randReset( 0 );

  m     = (VRegIncr_0x7a81360b75b3f561_t *) malloc( sizeof(VRegIncr_0x7a81360b75b3f561_t) );
  model = new VRegIncr_0x7a81360b75b3f561();
...
void destroy_model( VRegIncr_0x7a81360b75b3f561_t * m ) {

  VRegIncr_0x7a81360b75b3f561 * model = (VRegIncr_0x7a81360b75b3f561 *) m->model;
...
void eval( VRegIncr_0x7a81360b75b3f561_t * m ) {
...
#if VLINETRACE
void trace( VRegIncr_0x7a81360b75b3f561_t * m, char* str ) {
